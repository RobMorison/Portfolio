...
const Hero = () => {
    return ( 
        <>
        <div className='hero'>
            <p>Amet nostrud est officia culpa ex. Non et non incididunt nostrud culpa amet voluptate nulla adipisicing sit ad laboris. Mollit ipsum ex reprehenderit dolor quis proident aliquip reprehenderit sint irure labore.</p>
